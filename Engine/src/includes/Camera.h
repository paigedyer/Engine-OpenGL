...
public:
    ...
    // Input is parameter in the form of camera defined ENUM
    // (Abstracts it from windowing systems)
    void ProcessKeyboard(Camera_Movement direction, float deltaTime);

    // Processes input from a mouse input system
    // Expects offset value in both the x and y direction
        // Optional constrain pitch boolean
